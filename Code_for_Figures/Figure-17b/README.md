...
in order to obtain Figure 17b in the paper, just open "a06_PRECSN_BICKL.py" and run it.
...
- a03_FIELD0_BICKL.py: File that imports the flow field of the Bickley Jet.
                       
- a02_PRECSN_BICKL.py: Script that should be run in order to obtain Figure 17b in our paper.
