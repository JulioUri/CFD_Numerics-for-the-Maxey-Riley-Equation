...
in order to obtain Figure 08 in the paper, just open "a06_CONVRG_OSCLT.py" and run it.
...
- a02_CONVRG_OSCLT.py: Script that should be run in order to obtain Figure 08 in our paper.
