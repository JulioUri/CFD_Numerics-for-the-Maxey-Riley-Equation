...
in order to obtain Figure 18a in the paper, just open "a06_PRECSN_DATA1.py" and run it.
...
- a02_PRECSN_DATA1.py: Script that should be run in order to obtain Figure 18a in our paper.
