...
plt.savefig(save_plot_to + 'Figure_13a.pdf', format='pdf', dpi=500)
...
plt.savefig(save_plot_to + 'Figure_13b.pdf', format='pdf', dpi=500)
...
plt.savefig(save_plot_to + 'Figure_13c.pdf', format='pdf', dpi=500)
