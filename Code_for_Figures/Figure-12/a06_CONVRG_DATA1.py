...
plt.savefig(save_plot_to + 'Figure_12a.pdf', format='pdf', dpi=500)
...
plt.savefig(save_plot_to + 'Figure_12b.pdf', format='pdf', dpi=500)
...
plt.savefig(save_plot_to + 'Figure_12c.pdf', format='pdf', dpi=500)
