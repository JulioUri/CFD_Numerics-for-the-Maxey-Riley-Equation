...
in order to obtain Figure 17a in the paper, just open "a06_PRECSN_BICKL.py" and run it.
...
- a02_PRECSN_BICKL.py: Script that should be run in order to obtain Figure 17a in our paper.
