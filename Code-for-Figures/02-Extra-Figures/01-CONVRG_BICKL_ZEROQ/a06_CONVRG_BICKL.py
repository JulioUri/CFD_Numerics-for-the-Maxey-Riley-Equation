...
plt.savefig(save_plot_to + 'CONVRG_BICKL_ZEROQ_a.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_BICKL_ZEROQ_a.pdf', save_plot_to + 'CONVRG_BICKL_ZEROQ_a.pdf'])
...
plt.savefig(save_plot_to + 'CONVRG_BICKL_ZEROQ_b.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_BICKL_ZEROQ_b.pdf', save_plot_to + 'CONVRG_BICKL_ZEROQ_b.pdf'])
...
plt.savefig(save_plot_to + 'CONVRG_BICKL_ZEROQ_c.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_BICKL_ZEROQ_c.pdf', save_plot_to + 'CONVRG_BICKL_ZEROQ_c.pdf'])
