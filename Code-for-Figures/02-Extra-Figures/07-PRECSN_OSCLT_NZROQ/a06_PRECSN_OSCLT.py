...
# Save plot
plt.savefig(save_plot_to + 'PRECSN_OSCLT_NZROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'PRECSN_OSCLT_NZROQ.pdf', save_plot_to + 'PRECSN_OSCLT_NZROQ.pdf'])
