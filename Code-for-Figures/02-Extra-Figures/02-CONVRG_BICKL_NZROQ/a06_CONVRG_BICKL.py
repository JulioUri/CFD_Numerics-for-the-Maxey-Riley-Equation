...
plt.savefig(save_plot_to + 'CONVRG_BICKL_NZROQ_a.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_BICKL_NZRO_a.pdf', save_plot_to + 'CONVRG_BICKL_NZROQ_a.pdf'])
...
plt.savefig(save_plot_to + 'CONVRG_BICKL_NZROQ_b.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_BICKL_NZROQ_b.pdf', save_plot_to + 'CONVRG_BICKL_NZROQ_b.pdf'])
...
plt.savefig(save_plot_to + 'CONVRG_BICKL_NZROQ_c.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_BICKL_NZROQ_c.pdf', save_plot_to + 'CONVRG_BICKL_NZROQ_c.pdf'])
