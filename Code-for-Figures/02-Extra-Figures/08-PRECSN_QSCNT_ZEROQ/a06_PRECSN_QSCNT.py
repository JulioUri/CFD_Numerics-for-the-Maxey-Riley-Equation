...
# Save plot
plt.savefig(save_plot_to + 'PRECSN_QSCNT_ZEROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'PRECSN_QSCNT_ZEROQ.pdf', save_plot_to + 'PRECSN_QSCNT_ZEROQ.pdf'])
