...
plt.plot(L_v[2:4], 1e-1*L_v[2:4]**(-1.0), '--', color='grey', linewidth=1.0)
plt.text(145, 1e-3, "$N^{-1}$", color='grey')
plt.plot(L_v[2:4], 2e-2*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(145, 5e-10, "$N^{-3}$", color='grey')
...
plt.savefig(save_plot_to + 'CONVRG_DATA1_NZROQ_a.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_DATA1_NZROQ_a.pdf', save_plot_to + 'CONVRG_DATA1_NZROQ_a.pdf'])
...
plt.plot(L_v[2:4], 1e-1*L_v[2:4]**(-1.0), '--', color='grey', linewidth=1.0)
plt.text(145, 1e-3, "$N^{-1}$", color='grey')
plt.plot(L_v[2:4], 7e-3*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(145, 1e-10, "$N^{-3}$", color='grey')
...
plt.savefig(save_plot_to + 'CONVRG_DATA1_NZROQ_b.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_DATA1_NZROQ_b.pdf', save_plot_to + 'CONVRG_DATA1_NZROQ_b.pdf'])
...
plt.text(145, 7e-11, "$N^{-3}$", color='grey')
