...
plt.plot(L_v[2:4], 2.5e-2*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(145, 3e-6, "$N^{-2}$", color='grey')
plt.plot(L_v[2:4], 4e-3*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(145, 6e-11, "$N^{-3}$", color='grey')

plt.plot(L_v[:-1], Prasath_err_dic[0], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw)
...
plt.plot(L_v[:-1], Daitche_err_dic[0], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw)
...
plt.savefig(save_plot_to + 'CONVRG_DATA1_ZEROQ_a.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_DATA1_ZEROQ_a.pdf', save_plot_to + 'CONVRG_DATA1_ZEROQ_a.pdf'])
...
plt.plot(L_v[2:4], 2.1e-2*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(145, 2e-6, "$N^{-2}$", color='grey')
plt.plot(L_v[2:4], 6e-4*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(145, 8e-12, "$N^{-3}$", color='grey')

plt.plot(L_v[:-1], Prasath_err_dic[1], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw)
...
plt.plot(L_v[:-1], Daitche_err_dic[1], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw)
...
plt.savefig(save_plot_to + 'CONVRG_DATA1_ZEROQ_b.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_DATA1_ZEROQ_b.pdf', save_plot_to + 'CONVRG_DATA1_ZEROQ_b.pdf'])
...
plt.plot(L_v[2:4], 4.5e-2*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(145, 5e-6, "$N^{-2}$", color='grey')
plt.plot(L_v[2:4], 2e-3*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(145, 4e-11, "$N^{-3}$", color='grey')


plt.plot(L_v[:-1], Prasath_err_dic[2], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw)
...
plt.plot(L_v[:-1], Daitche_err_dic[2], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw)
...
plt.savefig(save_plot_to + 'CONVRG_DATA1_ZEROQ_c.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'CONVRG_DATA1_ZEROQ_c.pdf', save_plot_to + 'CONVRG_DATA1_ZEROQ_c.pdf'])
...
def export_legend(legend, filename="Figure_legend.pdf", expand=[-65,-55,-15,5]):
    fig  = legend.figure
    fig.canvas.draw()
