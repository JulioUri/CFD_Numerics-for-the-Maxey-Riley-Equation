...
in order to obtain Figure 15a in the paper, just open "a06_PRECSN_OSCLT.py" and run it.
...
- a03_FIELD0_OSCLT.py: File that imports the flow field of the Oscillatory background described in Prasath et al. (2019).
                       
- a02_PRECSN_OSCLT.py: Script that should be run in order to obtain Figure 15a in our paper.
...
- a09_PRTCLE_OSCLT.py: Script that has the class of a particle that calculates its trajectory using on the oscillatory background described by Prasath et al. (2004), using their solution. The update method within this class calculates the trajectory of the particle exactly.
