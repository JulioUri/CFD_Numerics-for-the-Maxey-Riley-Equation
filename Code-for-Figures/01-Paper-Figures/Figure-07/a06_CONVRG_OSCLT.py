...
plt.text(145, 4.5e-4, "$N^{-2}$", color='grey', fontsize=N_fs)
plt.plot(L_v[2:4], 1*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(135, 2e-8, "$N^{-3}$", color='grey', fontsize=N_fs)
...
call(["pdfcrop", save_plot_to + 'Figure_07a.pdf', save_plot_to + 'Figure_07a.pdf'])
...
plt.text(145, 2.5e-4, "$N^{-2}$", color='grey', fontsize=N_fs)
plt.plot(L_v[2:4], 5.*L_v[2:4]**(-3.0), '--', color='grey',                              linewidth=1.0)
plt.text(145, 9e-8, "$N^{-3}$", color='grey', fontsize=N_fs)
plt.plot(L_v[2:4], 8e-1 * L_v[2:4]**(-4.0), '--', color='grey',                              linewidth=1.0)
plt.text(145, 5e-9, "$N^{-4}$", color='grey', fontsize=N_fs)
...
call(["pdfcrop", save_plot_to + 'Figure_07b.pdf', save_plot_to + 'Figure_07b.pdf'])
...
plt.text(145, 5.5e-4, "$N^{-2}$", color='grey', fontsize=N_fs)
plt.plot(L_v[2:4], 1*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(135, 2e-8, "$N^{-3}$", color='grey', fontsize=N_fs)
...
call(["pdfcrop", save_plot_to + 'Figure_07c.pdf', save_plot_to + 'Figure_07c.pdf'])
