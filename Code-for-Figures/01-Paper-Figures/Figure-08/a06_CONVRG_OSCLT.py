...
plt.savefig(save_plot_to + 'Figure_08a.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'Figure_08a.pdf', save_plot_to + 'Figure_08a.pdf'])
...
plt.savefig(save_plot_to + 'Figure_08b.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'Figure_08b.pdf', save_plot_to + 'Figure_08b.pdf'])
...
plt.savefig(save_plot_to + 'Figure_08c.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + 'Figure_08c.pdf', save_plot_to + 'Figure_08c.pdf'])
