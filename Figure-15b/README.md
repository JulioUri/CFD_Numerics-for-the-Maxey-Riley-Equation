...
in order to obtain Figure 15b in the paper, just open "a06_PRECSN_OSCLT.py" and run it.
...
- a02_PRECSN_OSCLT.py: Script that should be run in order to obtain Figure 15b in our paper.
