...
in order to obtain Figure 14 in the paper, just open "a06_PRECSN_VORTX.py" and run it.
...
- a03_FIELD0_VORTX.py: File that imports the flow field of the Vortex described in Candelier et al. (2004).
                       
- a02_PRECSN_VORTX.py: Script that should be run in order to obtain Figure 14 in our paper.
...
- a09_PRTCLE_VORTX.py: Script that has the class of a particle that calculates its trajectory using on the velocity field described by Candelier et al. (2004), using their solution. The update method within this class calculates the trajectory of the particle exactly.
