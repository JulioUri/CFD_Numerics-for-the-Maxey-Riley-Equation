...
head = ["R:", str(round((1.+2.*(rho_p[0]/rho_f[0]))/3., 2)),
              ...
              str(round((1.+2.*(rho_p[3]/rho_f[2]))/3., 2)),
              str(round((1.+2.*(rho_p[4]/rho_f[2]))/3., 2))]
...
plt.plot(L_v, Prasath_err_dic[0], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw)
...
plt.plot(L_v, Daitche_err_dic[0], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw)
...
plt.plot(L_v, Prasath_err_dic[1], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw)
...
plt.plot(L_v, Daitche_err_dic[1], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw)
...
plt.plot(L_v, Prasath_err_dic[2], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw)
...
plt.plot(L_v, Daitche_err_dic[2], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw)
...
plt.plot(L_v, Prasath_err_dic[3], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw)
plt.plot(L_v, Trap_err_dic[3],    'v-', color='green',  label="FD2 + Trap. Rule",      linewidth=lw)
plt.plot(L_v, IMEX2_err_dic[3],   's-', color='violet', label="FD2 + IMEX2",           linewidth=lw)
plt.plot(L_v, Daitche_err_dic[3], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw)
plt.plot(L_v, IMEX4_err_dic[3],   'o-', color='red',    label="FD4 + IMEX4",           linewidth=lw)
plt.plot(L_v, DIRK4_err_dic[3],   '+-', color='blue',   label="FD4 + DIRK4",           linewidth=lw)
...
plt.plot(L_v, Prasath_err_dic[4], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw)
plt.plot(L_v, Trap_err_dic[4],    'v-', color='green',  label="FD2 + Trap. Rule",      linewidth=lw)
plt.plot(L_v, IMEX2_err_dic[4],   's-', color='violet', label="FD2 + IMEX2",           linewidth=lw)
plt.plot(L_v, Daitche_err_dic[4], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw)
plt.plot(L_v, IMEX4_err_dic[4],   'o-', color='red',    label="FD4 + IMEX4",           linewidth=lw)
plt.plot(L_v, DIRK4_err_dic[4],   '+-', color='blue',   label="FD4 + DIRK4",           linewidth=lw)
