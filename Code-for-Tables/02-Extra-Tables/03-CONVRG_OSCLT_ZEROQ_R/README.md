...
in order to obtain Figure 07 in the paper, just open "a06_CONVRG_OSCLT.py" and run it.
...
- a02_CONVRG_OSCLT.py: Script that should be run in order to obtain Figure 07 in our paper.
...
- a09_PRTCLE_OSCLT.py: Script that has class the of a particle that moves in the Oscillatory background defined in Prasath et al. for which there is an analytical solution. The update method in this class calculates the trajectory of the particle.
